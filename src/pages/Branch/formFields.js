...
export const validationSchema = yup.object({
    name: yup.string().trim().min(2, i18n.t("branchNameMinLength")).max(200,i18n.t("branchNameMaxLength")).required(i18n.t("codeIdentifier")),
    ...
    city: yup.string().min(2, i18n.t("branchCityLength")).max(20,i18n.t("branchCityMax")).required(i18n.t("branchCity")),
    code: yup.string().min(5, i18n.t("branchCodeLength")).max(20,i18n.t("branchCityCodeMax")).required(i18n.t("branchCode")),
